...
public class CentralLimitTheorem extends PApplet {
...
public void drawPegs(int r, int b, int g)
{
  // Loop over the rows.
...
public void keyReleased()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "CentralLimitTheorem" };
    if (passedArgs != null) {
